...
for repeat in range(3):
    for t in np.concatenate((np.linspace(0.18, 3.14 - 0.18, 1000),
                             np.linspace(3.14 + 0.18, 2 * 3.1415 - 0.18, 1000)), axis=0):
...
for repeat in range(3):
    for t in np.concatenate((np.linspace(0.2, 3.14 - 0.2, 1000),
                             np.linspace(3.14 + 0.2, 2 * 3.1415 - 0.2, 1000)), axis=0):
...
bloom_indices = np.linspace(0, size_steps - 1, 20)
shrink_indices = np.linspace(size_steps - 1, 0, 15)
...
while running:
    ...
    index = indices[(frame * ADVANCE_STEP) % len(indices)]
